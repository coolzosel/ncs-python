from step3_titanic.models.dataset import Dataset
import pandas as pd
import numpy as np
...
class Service(object):
    ...
    def create_train(this):
        ...
        # axis 축, 0이면 횡축(가로) 1이면 종축(세로)
        # survived 값을 지워라 (가상의 데이터를 넣으려고)
    ...
    @staticmethod
    def embarked_nominal(this) -> object: #숫자화
    ...
    def title_nominal(this) -> object:
        ...
        for dataset in combine:
            ...
            title_mapping = {'Mr': 1, 'Miss': 2, 'Mrs': 3, 'Royal': 5, 'Rare': 6}
            for dataset in combine:
                dataset['Title'] = dataset['Title'].map(title_mapping)
                dataset['Title'] = dataset['Title'].fillna(0) # 호칭없으면 전부 하층민으로 침
    ...
    def age_ordinal(this) -> object:
        ...
        bins = [-1, 0, 5, 12, 18, 24, 35, 50, np.inf]
